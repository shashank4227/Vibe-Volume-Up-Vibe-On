  ...
  return (
    <>
      <header className="header relative">
        ...
        <div className="search-bar desktop-only relative" ref={searchRef}>
      ...
      {showMobileSearch && (
        <div className="mobile-search-container absolute top-[80px] left-0 right-0 bg-[#111] p-4 z-40">
          <div className="mobile-search-bar relative">
            <input 
              ...
              onChange={handleSearch}
              autoFocus
              className="w-full p-3 bg-[#222] text-white rounded border border-[#333] focus:border-[#FF2DD1] outline-none"
            />
             {query.length > 0 && <SearchResults />}
          </div>
        </div>
